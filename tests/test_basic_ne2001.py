...
def test_dm_to_dist():
    ...
    b = pygedm.dm_to_dist(
        Angle(204, unit="degree"), Angle(-6.5, unit="degree"), 200, method="ne2001"
    )
...
def test_basic():
    ...
    for dist in (10.0 * u.pc, 100.0 * u.pc, 1000.0 * u.pc):
